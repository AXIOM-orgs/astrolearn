...
"[project]/app/host/monitor/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function HostMonitorPage() {
    ...
    const [timeRemaining, setTimeRemaining] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(300); // 5 minutes
    const [totalQuestions, setTotalQuestions] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(10);
    // Load session info and poll for player progress
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HostMonitorPage.useEffect": ()=>{
            const session = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gameSession$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGameSession"])();
            if (session) {
                setTotalQuestions(session.selectedQuestions);
            }
            // Poll for player progress
            const pollInterval = setInterval({
                "HostMonitorPage.useEffect.pollInterval": ()=>{
            ...
            }["HostMonitorPage.useEffect.pollInterval"], 1000);
            return ({
                "HostMonitorPage.useEffect": ()=>clearInterval(pollInterval)
            })["HostMonitorPage.useEffect"];
        }
    }["HostMonitorPage.useEffect"], []);
    // Timer countdown
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HostMonitorPage.useEffect": ()=>{
            const timer = setInterval({
                "HostMonitorPage.useEffect.timer": ()=>{
                    setTimeRemaining({
                        "HostMonitorPage.useEffect.timer": (prev)=>{
                            if (prev <= 1) {
                                clearInterval(timer);
                                return 0;
                            }
            ...
            }["HostMonitorPage.useEffect.timer"], 1000);
            return ({
                "HostMonitorPage.useEffect": ()=>clearInterval(timer)
            })["HostMonitorPage.useEffect"];
        }
    }["HostMonitorPage.useEffect"], []);
    ...
    const handleEndGame = ()=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gameSession$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["endGameSession"])();
        router.push('/host/leaderboard');
    };
    const completedPlayers = players.filter((p)=>p.progress >= 100).length;
    const fleetCapacity = "".concat(players.length, "/24");
        ...
        children: [
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            style: {
                                width: "".concat(players.length / 24 * 100, "%")
                            }
                        }, void 0, false, {
                            fileName: "[project]/app/host/monitor/page.tsx",
                            lineNumber: 103,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: players.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    lineNumber: 117,
                    columnNumber: 21
                }, this) : players.map((player)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    player.spacecraft ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "progress-bar-fill ".concat(player.progress >= 100 ? 'complete' : ''),
                                    style: {
                                        width: "".concat(player.progress, "%")
                                    }
                                }, void 0, false, {
                                    fileName: "[project]/app/host/monitor/page.tsx",
                                    lineNumber: 144,
...
_s(HostMonitorPage, "q5mN+jRU0a0S8rtp9LWMxrSwZM8=", false, function() {
    return [
...
_c = HostMonitorPage;
var _c;
__turbopack_context__.k.register(_c, "HostMonitorPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_fc0336b1._.js.map