...
"[project]/lib/miniGame.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function returnSmokeToPool(particle) {
...
let particleMultiplier = 1; // 1 = full, 0.5 = half
function detectMobileAndSetPerformance() {
...
// Boss Death Visuals
let bossExplosionImage = null;
let fireRingImage = null;
let bossDeathEffect = {
    active: false,
    startTime: 0,
    x: 0,
...
function startMiniGame(spaceship, difficulty, callback) {
    ...
    difficultyConfig = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["difficultyConfigs"][difficulty];
    ...
    for(let i = 0; i < backgroundImages.length; i++){
        ...
        if (img && img.complete) {
            ...
            if (renderW < canvas.width) {
                ...
                ctx.drawImage(img, sX, sY, sW, sH, 0, Math.floor(bgPanelY[i]), canvas.width, canvas.height);
            } else {
...
function fireBullets() {
    ...
    if (secondaryWeapon && secondaryWeaponConfig) {
        if (secondaryWeaponConfig.type === 'laser') {
            ...
            bullet.targetAsteroid = targetResult.target || undefined;
...
//# sourceMappingURL=_f8ae5497._.js.map